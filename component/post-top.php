            ...
            <div class="flex w-1/2 flex-row">
                <a href="<?php $item->permalink(); ?>" title="<?php $item->title(); ?>" class="w-[130px]"
                   title="<?php $item->title(); ?>">
                    <img
                        src="<?php echo getThumbnail($item->cid, 'data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs='); ?>"
                        alt="" width="130"
                        height="90"
                        alt="<?php $item->title(); ?>"
                        class="h-[90px] w-[130px] rounded object-cover hover:shadow-lg"/>
                </a>
